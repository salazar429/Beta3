...
const App = {
    ...
    async verificarConexion() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log(`✅ Servidor OK - ${data.productos} productos, ${data.vendedoras} vendedoras, ${data.categorias} categorías`);
            }
        } catch (error) {
            ...
            categorias.forEach(c => {
                html += `
                    <div class="vendedora-card" data-categoria-id="${c.id}">
                        ...
                        <div id="edit-categoria-${c.id}" class="edit-producto-form" style="display: none; margin-top: 15px;">
    ...
    async actualizarCategoria(id) {
        ...
        if (!nombre) {
            this.mostrarNotificacion('❌ El nombre es obligatorio');
            return;
        }
        ...
        try {
            ...
            if (response.ok && data.success) {
                ...
                this.mostrarNotificacion('❌ Error: ' + (data.error || 'No se pudo actualizar'));
            }
        } catch (error) {
    ...
    async eliminarCategoria(id) {
        if (!confirm('¿Eliminar esta categoría? Los productos que la usan se moverán a "Sin categoría"')) return;
        ...
        try {
            ...
            if (response.ok && data.success) {
                ...
                if (data.error && data.productos) {
                    ...
                    this.mostrarNotificacion('❌ Error: ' + (data.error || 'No se pudo eliminar'));
                }
            }
        } catch (error) {
    ...
    async eliminarVendedora(id) {
        ...
        try {
            ...
            this.mostrarNotificacion('❌ Error eliminando vendedora');
        }
    },
            ...
            productos.forEach(p => {
                ...
                html += `
                    <div class="producto-card" data-producto-id="${p.id}">
                        <div class="producto-header">
                            <div>
                                ...
                                <div style="font-size: 0.8rem; color: #666; margin-top: 4px;">
                                    🏷️ ${p.categoria_nombre || 'Sin categoría'}
                                </div>
                            </div>
                        ...
                        <div id="edit-form-${p.id}" class="edit-producto-form" style="display: none;">
                            <div style="display: flex; flex-direction: column; gap: 15px;">
                                ...
                                <div>
                                    ...
                                    <select id="editCategoria-${p.id}" class="form-control" data-categoria-actual="${p.categoria || ''}">
    ...
    async actualizarProducto(id) {
        ...
        if (!nombre || isNaN(precio) || isNaN(stock)) {
            this.mostrarNotificacion('❌ Todos los campos son obligatorios');
            return;
        }
        ...
        try {
            ...
            this.mostrarNotificacion('❌ Error actualizando producto');
        }
    },
    ...
    async eliminarProducto(id) {
        ...
        try {
            ...
            this.mostrarNotificacion('❌ Error eliminando producto');
        }
    },
